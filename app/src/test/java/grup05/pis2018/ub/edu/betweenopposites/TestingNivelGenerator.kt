...
import grup05.pis2018.ub.edu.betweenopposites.Model.ConjuntoNiveles
...
class TestingNivelGenerator {
    ...
    fun testingCreacionDeNiveles(){
        // Creo un nivel
        var nivel: Nivel = FactoryNiveles.crearNivelfromTXT(1,7,1, Plantilla.salaBasica.listaPlantillas,Plantilla.salaEspecial.listaPlantillas,Plantilla.salaFinal.listaPlantillas)
        println(nivel.printNivel())
    }*/

    /*@Test
    fun probarConjuntoNIveles(){
        // Creo los niveles
        var conjuntoNiveles: ConjuntoNiveles = ConjuntoNiveles()
    }*/
